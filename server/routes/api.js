...
import { executeDispatch, getActiveCases } from '../controllers/dispatchController.js';
...
router.post('/triage/voice-parse', async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, error: 'Failed to process voice transcript' });
  }
});
